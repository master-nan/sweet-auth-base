...
func InitializeApp() (*App, error) {
	...
	orgService := service.NewOrgService(orgLegalEntityRepositoryImpl, orgUnitRepositoryImpl, orgStructureRepositoryImpl, orgStructureNodeRepositoryImpl, orgEmployeeRepositoryImpl, orgPositionRepositoryImpl)
