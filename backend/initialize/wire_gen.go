...
func InitializeApp() (*App, error) {
	...
	reportService := service.NewReportService(reportDefinitionRepositoryImpl, reportExecutionLogRepositoryImpl, generalizationService, sysTableService, dataPermissionService, snowflake)
