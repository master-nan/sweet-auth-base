...
var RepositoryProvider = wire.NewSet(
	...
	impl.NewOrganizationHRSyncRepositoryImpl,
	...
	wire.Bind(new(repository.OrganizationHRSyncRepository), new(*impl.OrganizationHRSyncRepositoryImpl)),
...
var ServiceProvider = wire.NewSet(
	...
	service.NewOrganizationHRSyncService,
	ProvideOrganizationSyncConsumerRegistry,
