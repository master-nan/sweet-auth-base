...
func strictCoverageException(route auditedRoute) bool {
	exceptions := map[auditedRoute]struct{}{
		...
		{path: "/admin/runtime/notifications/unread-count", method: "GET"}:        {},
		{path: "/admin/runtime/notifications/recent", method: "GET"}:              {},
		{path: "/admin/runtime/notifications/query", method: "POST"}:              {},
		{path: "/admin/runtime/notifications/:id", method: "GET"}:                 {},
		{path: "/admin/runtime/notifications/:id/read", method: "POST"}:           {},
		{path: "/admin/runtime/notifications/read-all", method: "POST"}:           {},
