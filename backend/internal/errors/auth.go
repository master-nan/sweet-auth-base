...
const (
	...
	ErrorCodeUserSessionExportTooLarge = 20017
...
var (
	...
	ErrUserSessionExportTooLarge = newApplicationError(KindUnprocessable, CategoryBusiness, ErrorCodeUserSessionExportTooLarge, "登录记录超过 10000 条，请缩小查询时间范围后再导出")
