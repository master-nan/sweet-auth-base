...
本设计遵守 [PlatformStabilizationReview.md](../reviews/PlatformStabilizationReview.md) 的平台准入结论，以及 [TransactionUsageStandard.md](../standards/TransactionUsageStandard.md)、[ErrorHandlingStandard.md](../standards/ErrorHandlingStandard.md)、[TestInfrastructureStandard.md](../standards/TestInfrastructureStandard.md) 的工程规范。文中对象均为领域概念，不代表已经确定数据表、字段类型或物理存储结构。
