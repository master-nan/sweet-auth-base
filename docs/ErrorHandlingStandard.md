...
- 认证入口的安全策略和职责边界遵循 [AuthenticationArchitectureDesign.md](AuthenticationArchitectureDesign.md)。
- 后端整体整改优先级参考 [PlatformBackendCodeAuditReport.md](PlatformBackendCodeAuditReport.md)。
