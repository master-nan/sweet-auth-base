...
export enum SysMenuButtonEventAction {
  ...
  ASSIGN_DATA_PERMISSION = 'assign_data_permission',
  QUERY_USER_MENU = 'query_user_menu',
  QUERY_DATA_PERMISSION = 'query_data_permission',
...
export const SysMenuButtonEventActionMap = {
  ...
  [SysMenuButtonEventAction.ASSIGN_DATA_PERMISSION]: '分配数据权限',
  [SysMenuButtonEventAction.QUERY_USER_MENU]: '用户菜单查询',
  [SysMenuButtonEventAction.QUERY_DATA_PERMISSION]: '数据权限查询',
