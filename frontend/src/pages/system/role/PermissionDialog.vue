...
const visibleMenuButtons = computed(() => sortButtons(menuButtons.value.filter(isPageButton)))
const apiPermissionButtons = computed(() => sortButtons(menuButtons.value.filter(isApiPermission)))
...
const fetchMenuTree = async () => {
  ...
  const result = await queryMenu(query)
