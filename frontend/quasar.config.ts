...
export default defineConfig((ctx) => {
  return {
    ...
    boot: ['i18n', 'axios', 'bus', 'layout', 'permission', 'table-overlay-scrollbar'],
    ...
    build: {
      ...
      extendViteConf(viteConf) {
        ...
        viteConf.build.rollupOptions.output = {
          ...(typeof viteConf.build.rollupOptions.output === 'object' &&
          ...
          manualChunks(id: string) {
            ...
            if (id.includes('/@wangeditor/')) return 'vendor-richtext'
            if (id.includes('/lodash/')) return 'vendor-lodash'
            if (id.includes('/axios/') || id.includes('/qs/')) return 'vendor-http'
            return undefined
          },
        }
      },
    ...
    framework: {
      ...
      // Quasar plugins
      plugins: ['LoadingBar', 'Meta', 'Notify', 'LocalStorage', 'AppFullscreen', 'Dialog'],
    },
